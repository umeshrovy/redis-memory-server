...
var log = (0, debug_1.default)('RedisMS:RedisBinaryDownloadUrl');
/**
    ...
    RedisBinaryDownloadUrl.prototype.getDownloadUrl = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        downloadUrl = (0, resolve_config_1.default)('DOWNLOAD_URL');
                        if (downloadUrl) {
                            log("Using \"" + downloadUrl + "\" as the Download-URL");
                            return [2 /*return*/, downloadUrl];
                        }
                        if (process.platform === 'win32') {
                            return [2 /*return*/, 'https://github.com/ServiceStack/redis-windows/raw/master/downloads/redis-latest.zip'];
                        }
                        return [4 /*yield*/, this.getArchiveName()];
                    case 1:
                        archive = _b.sent();
                        log("Using \"" + archive + "\" as the Archive String");
                        mirror = (_a = (0, resolve_config_1.default)('DOWNLOAD_MIRROR')) !== null && _a !== void 0 ? _a : 'https://download.redis.io';
                        log("Using \"" + mirror + "\" as the mirror");
                        return [2 /*return*/, mirror + "/releases/" + archive];
                }
            });
        });
    };
